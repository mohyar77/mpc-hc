; *** Inno Setup version 5.5.3+ Persian messages ***
;
; Translated by Mohammad Yarahmadi <http://www.iyarahmadi.ir>
...
; *** Application titles
SetupAppTitle=نصب نرم افزار
SetupWindowTitle=نصب - %1
UninstallAppTitle=حذف نرم افزار
UninstallAppFullTitle=%1 پاک کردن
...
; *** SetupLdr messages
SetupLdrStartupMessage= %1. ایا ادامه می دهید؟
LdrCannotCreateTemp=عدم نصب برنامه های سیستمی ، نصب لغو می شود
LdrCannotExecTemp=خطا در فایل سیستمی، نصب لغو می شود
...
ButtonCancel=انصراف
ButtonYes=&بله
ButtonYesToAll=تایید برای همه
ButtonNo=&خیر
ButtonNoToAll=خیر برای همه
ButtonFinish=&پایان
ButtonBrowse=&بازکردن...
ButtonWizardBrowse=با&زکردن...
ButtonNewFolder=&پوشه جدید

; *** "Select Language" dialog messages
SelectLanguageTitle=زبان نصب را انتخاب کتید
